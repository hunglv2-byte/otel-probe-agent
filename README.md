...
java \
  ...
  -Dotel.probe.agent.packages.exclude=jp.joinsure.policy.console.port,jp.joinsure.console.port.adapter.config \
  -Dotel.probe.agent.packages.include=jp.joinsure \
